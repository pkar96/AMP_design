...
def simulated_anneal(PDB_data, PDB_rows, prob_02, prob_24, prob_46, prob_68):
       init_temp=1
       temp=1
       final_temp=0.001
       c=1
...
PDB=simulated_anneal(PDB_data, PDB_rows, prob_02, prob_24, prob_46, prob_68) 
